package com.ifox.springbootspringsecurityjwt.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ifox.web.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "API TOS",
                "Terms of service",
                new Contact("Zhong Chao", "www.110.com", "110.com"),
